...
export default function Home() {
  return <main className="flex flex-col justify-between p-12 max-w-7xl w-full m-auto my-2">
    ...
    <div className='flex'>
      ...
      <a href="https://github.com/RoberTnf/lazy-idle"><div> Check out the code<GitHub className='w-8 h-8 m-2' /></div></a>
      <a href="https://ko-fi.com/robertodiaztnf">
        <div>Buy me a coffee <svg className='w-8 h-8 m-2 inline' xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
